...
export const Publish = ({ initialData }: PublishProps) => {
  ...
  const onPublish = () => {
    ...
    toast.promise(promise, {
      loading: "Your note is being published...",
      success: "Your note has been successfully published",
      error: "There was an error while publishing note",
    });
  };
  ...
  const onUnpublish = () => {
    ...
    toast.promise(promise, {
      loading: "Your note is being removed from published state...",
      success: "Your note has been unpublished",
      error: "There was an error while unpublishing note",
    });
  };
      ...
      <Popover>
        <PopoverTrigger asChild>
          <Button size='sm' variant='ghost'>
            Publish {initialData.isPublished && <Globe className='h-4 w-4 text-sky-500 ml-2' />}
          </Button>
        </PopoverTrigger>
